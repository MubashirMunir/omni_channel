...
void showReplyDialog(
    GmailController ctrl,
    GmailMessageModel mail,
    ) {
  ctrl.prepareReplyDialog(mail);
                ...
                Flexible(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        DialogTextFields(
                          controller: ctrl.replyToController,
                          label: 'To',
                        ...
                        DialogTextFields(
                          controller: ctrl.replyCcController,
                          label: 'CC',
                          hint: 'optional',
                        ...
                        DialogTextFields(
                          controller: ctrl.replySubjectController,
                          label: 'Subject',
                          hint: 'Email subject',
                          icon: Icons.subject,
                        ),
                        ...
                        TextField(
                          controller: ctrl.replyBodyController,
                          minLines: 8,
                          maxLines: 12,
